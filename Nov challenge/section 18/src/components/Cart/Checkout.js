    ...
    return (
        <form className={classes.form} onSubmit={confirmHandler}>
            ...
            <div className={streetControlClasses}>
                ...
                <input type='text' id='street' ref={streetInputRefInputRef} />
                {!formInputsValidity.street && <p>Please enter a valid street!</p>}
            </div>
            <div className={postalCodeControlClasses}>
                <label htmlFor='postal'>Postal Code</label>
                <input type='text' id='postal' ref={postalCodeInputRefInputRef} />
                {!formInputsValidity.postalCode && <p>Please enter a valid postal code!(5 characters long)</p>}
            </div>
            <div className={cityControlClasses}>
                <label htmlFor='city'>City</label>
                <input type='text' id='city' ref={cityInputRefInputRef} />
